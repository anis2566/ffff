...
export const ResultList = ({ results }: HomeworkListProps) => {
  ...
  return (
    <Table>
      ...
      <TableBody>
        {results.map((result) => (
          <TableRow key={result.id} className="even:bg-muted">
            ...
            <TableCell>
              <ListActions>
                <ListActionLink
                  ...
                  icon={Eye}
                  hasPermission={hasPermission("result", "read")}
                />
                <ListActionLink
                  title="Edit"
                  href={`/exam/result/edit/${result.id}`}
                  icon={Edit}
                  hasPermission={hasPermission("result", "update")}
                />
                <ListActionButton
                  title="Toggle Status"
                  icon={RefreshCcw}
                ...
                <ListActionButton
                  ...
                  hasPermission={hasPermission("result", "delete")}
                />
              </ListActions>
            </TableCell>
          </TableRow>
