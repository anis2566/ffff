...
import { DueAdmissionMobileFilter } from "./mobile-due-admission-payment-filter";
...
export const DueAdmissionPaymentFilter = () => {
  const [filter, setFilter] = useGetDueAdmissionPayments();
  const trpc = useTRPC();
  ...
  return (
    <div className="flex-1 flex items-center justify-between gap-x-3">
      ...
      <div className="flex items-center gap-x-2">
        ...
        <DueAdmissionMobileFilter classes={classes || []} />
      </div>
    </div>
  );
};
