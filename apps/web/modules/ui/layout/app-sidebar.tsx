        ...
        items: [
          {
            ...
            icon: PlusCircle,
            items: [],
            permission: { module: "salary_payment", action: "receive_payment" },
          },
          {
            title: "History",
            url: "/fee/salary",
    ...
    items: [
      {
        ...
        icon: UserCog,
        items: [],
        permission: { module: "role", action: "read" },
        // role: "Admin",
      },
      {
        title: "Permission",
        ...
        icon: Key,
        items: [],
        permission: { module: "permission", action: "read" },
        // role: "Admin",
      },
    ],
  },
    ...
    items: [
      {
        ...
        url: "/chat",
        icon: MessageSquareMore,
        permission: { module: "chat", action: "read" },
        role: "Admin",
        items: [],
      },
    ],
